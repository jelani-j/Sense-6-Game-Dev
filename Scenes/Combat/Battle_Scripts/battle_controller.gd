...
func process_action():
	...
	battle_queue += await interpreter.action_interpreter(action_queue,enemy_array,player_array,minigame_container)
	battle_queue += await interpreter.action_interpreter(monster_action,enemy_array,player_array,minigame_container)
	action_queue.clear()
